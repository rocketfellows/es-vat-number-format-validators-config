...
namespace rocketfellows\ESVatNumberFormatValidatorsConfig\tests\unit;
...
use rocketfellows\ESVatNumberFormatValidatorsConfig\ESVatNumberFormatValidatorsConfig;

class ESVatNumberFormatValidatorsConfigTest extends TestCase
{
    private const TESTING_CONFIG_CLASS = ESVatNumberFormatValidatorsConfig::class;
    private const EXPECTED_CONFIG_DEFAULT_VALIDATOR_CLASS = ESVatFormatValidator::class;
    ...
    {
        $this->assertEquals(ISO3166::ES(), $config->getCountry());
    }
